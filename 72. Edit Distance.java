 ...
 * if  c1 != c2 -> case1: insert c2 at begining of w1-> minDistance(w1, w2) = 1 + minDistance(w1, rw2)
 *              -> case2: delete c1 at begining of w1-> minDistance(w1, w2) = 1 + minDistance(rw1, w2)
